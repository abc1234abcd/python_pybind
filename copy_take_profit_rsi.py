...
barely okay but no stop-loss tnx.
        ...
        if self.position is None :
            ...
            if entry_position:
                ...
                take_profit_condition = (
                    (curr_pnl > 0.001) or
                    ( curr_pnl > 0.005 and self.rsi_buffer[-1]  < self.rsi_buffer[-2]) or
                    (curr_pnl >0.0002 and self.order_flow_cache.normalized_net_flow < 0 and self.ob_cache.asks_qty/self.ob_cache.bids_qty > 100)
                )
